...
estratos_colapsado <- read_csv("../datos/reporte/estratos_colapsados.csv") %>% 
...
de votos 2015) tiene buena precisión sobre los tres estados, y es más simple que la estratificación 8.
- En Colima los candidatos son la estratificación 6 y la 4 (distrito federal x 2 grupos
...
replicar_sims <- function(frac_m = 0.15, runs = 50){
