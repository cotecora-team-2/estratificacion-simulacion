...
```{r}
casillas_2021 <- read_delim("../datos/19_UBICACION_CASILLAS_APROBADAS_CG_20210414_TSecc_ZonaArea.txt",
...
marco_2021 <-  marco_2021_imp %>% 
  select(-comp_marg, -comp_votos, -X42)
```
...
```{r}
write_rds(marco_conf_selec, "../datos/marco_2021.rds")
```
